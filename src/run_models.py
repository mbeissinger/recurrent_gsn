...
def main():
    ...
    parser.add_argument('--save_frequency', type=int, default=20) #number of epochs between parameters being saved
    parser.add_argument('--early_stop_delta_percent', type=float, default=0.1)

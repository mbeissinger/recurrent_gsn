...
'''
import argparse
import model_sequenced as model
#import model
...
def main():
    ...
    parser.add_argument('--K', type=int, default=2) # number of hidden layers default 2
    parser.add_argument('--N', type=int, default=4) # number of walkbacks default 4

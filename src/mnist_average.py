...
def main():
    ...
    print
    'train:', [trunc(c) for c in train_costs], "|", trunc(numpy.mean(train_costs))
    ...
    print
    'valid:', [trunc(c) for c in valid_costs], "|", trunc(numpy.mean(valid_costs))
    ...
    print
    'test:', [trunc(c) for c in test_costs], "|", trunc(numpy.mean(test_costs))

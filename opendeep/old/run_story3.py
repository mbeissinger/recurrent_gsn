...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=105) #batch size here to speed up training - doesn't work in practice unless you know the maximum sequence length. In my case it is 10, so using 10*10+walkbacks+1 allows the continuation of the recurrent hidden variables.
